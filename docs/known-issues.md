...
- Phase RH-1 is merged; RH-2 drafts special line/cross/wildcard cleansing for **Rift Erosion Lab**. Calm campaign-style Fantasy levels remain threat-free. Special-created protection wiring, campaign pressure levels, bosses, cleanse score bonuses, and new objective kinds remain deferred (RH-3+ / focused follow-ups). Coordinate-bound corruption does not block gravity. Cleansing does not reduce hunger and does not award score/collection. Lab balance is provisional (21-seed first-move probe remains a limited strategy, not balance proof) and still needs human playtesting before RH-3. See [rift-hunger-board-threat-direction.md](rift-hunger-board-threat-direction.md).
